...
public class FileEncoder61727 implements FileEncoder {
    ...
    public void decode(String encodedFile, String destinationFile, LinkedList<Character> key) {
        ...
        try {
            ...
            FileOutputStream fileOutputStr = new FileOutputStream(destinationFile);

            for (int i = 0, currChar = fileInputStr.read(); currChar != -1; ++i, currChar = fileInputStr.read()) {
                if (isPrime(i)) {
