...
public class AuthorBookIndexer implements IBookIndexer {
    ...
    public void buildIndex(String bookFilePath, String[] keywords, String indexFilePath) {
        ...
        HashMap<String, ArrayList<Pair>> keywordLocations = new HashMap<String, ArrayList<Pair>>();
        for (String keyword : sortedKeys) {
            keywordLocations.put(keyword, new ArrayList<Pair>());
        }
        try {
    ...
    private void writeIndex(String[] keywords,
        ...
        try {
            ...
            for (int i = 0; i < keywords.length; i++) {
                ...
                String locationsString = jre7Workaround(locations);
    ...
    private String jre7Workaround(List<Pair> list)
    {
